...
const PAGE_DATA = {
  title: "Occupational Physicals",
  subtitle: "Fit-for-Duty, Pre-Employment, and Annual Physicals — Fast Turnaround",
  features: [
    "Pre-employment and baseline physicals",
    "Fit-for-duty and return-to-work evaluations",
    "Respirator and job-specific screening add-ons",
    "Clear documentation for HR and supervisors",
  ],
  mainContent:
    "Physicals shouldn’t slow down hiring or operations. We provide efficient occupational physicals with job-relevant assessments and straightforward documentation, so your team can onboard faster and stay compliant.",
  ancillaryServices: ["Vision Screening", "Vitals & BMI", "Respirator Clearance", "Lab Add-Ons"],
  cta: "Schedule Physicals",
};
