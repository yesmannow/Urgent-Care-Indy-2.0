...
const PAGE_DATA = {
  ...
  subtitle: "Examinadores certificados por FMCSA para mantener a los conductores en regla.",
  features: [
    "Examinadores médicos certificados (FMCSA)",
    "Guía clara para condiciones médicas comunes",
    "Documentación lista para el cumplimiento",
    "Entrega rápida para volver a la ruta",
  ],
  mainContent:
    "Mantenga su flota en cumplimiento y en movimiento. Realizamos Examen Físico DOT con flujos eficientes y pasos claros, incluyendo cuándo se requiere documentación adicional.",
  cta: "Solicitar Examen Físico DOT",
};
