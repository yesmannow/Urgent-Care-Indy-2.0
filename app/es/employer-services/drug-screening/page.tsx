...
const PAGE_DATA = {
  ...
  subtitle: "Programas rápidos y en cumplimiento para empresas de Indianápolis.",
  features: [
    "Paneles 5/10/12",
    "Cadena de custodia y documentación para cumplimiento",
    "eScreen y confirmaciones de laboratorio disponibles",
    "Protocolos de reportes para contactos designados",
  ],
  mainContent:
    "Construya un programa de detección que proteja su fuerza laboral y reduzca el riesgo. Apoyamos flujos ocupacionales comunes y coordinamos reportes según las políticas de su organización.",
