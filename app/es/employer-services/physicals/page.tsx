...
const PAGE_DATA = {
  ...
  subtitle: "Aptitud laboral, pre-empleo y evaluaciones anuales con respuesta rápida.",
  features: [
    "Exámenes de pre-empleo y basales",
    "Aptitud laboral y evaluaciones de regreso al trabajo",
    "Complementos específicos según el puesto",
    "Documentación clara para RR. HH.",
  ],
  mainContent:
    "Los exámenes no deben frenar la contratación. Ofrecemos evaluaciones ocupacionales eficientes con documentación directa para que su equipo avance rápidamente.",
  cta: "Programar Exámenes",
};
