    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <p className="text-slate-600 text-lg mb-8 md:mb-10">
          Walk-ins are always welcome. Submitting this form alerts our staff to
          your arrival.
        </p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          {/* Left: Pexels clinic waiting room */}
          ...
          {/* Right: Form + Status + Contact */}
          <div className="space-y-6">
            {/* Current Clinic Status card */}
            <div
            ...
            >
              ...
              <p className="text-slate-600 mb-2">
                Walk-ins are always welcome. Submitting this form alerts our staff
                to your arrival.
              </p>
